import {
  ADD_NEW_PLAY, DELETE_PLAY, GET_ALL_PLAYS, TRY_TO_ADD_PLAY, TRY_TO_GET_ALL_PLAYS,
} from './playsActionsTypes';
...
export const deletePlay = (boardGameId, playId) => dispatch => deletePlayRequest(boardGameId, playId)
